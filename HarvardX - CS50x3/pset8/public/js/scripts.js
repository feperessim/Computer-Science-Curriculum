...
function addMarker(place)
{
  ...
  var marker = new google.maps.Marker({
    ...
    abelContent: place.place_name + ", " + place.admin_code1,
  ...
  var content = "<h3>News for " + place['place_name'] + ", " + place['admin_name1'] + "</h3><ul>";
  
  var articles = $.getJSON("articles.php", parameters)
