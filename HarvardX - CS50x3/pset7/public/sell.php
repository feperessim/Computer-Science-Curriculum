<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        else
        {
            ...
            $rows = query("SELECT shares FROM holdings WHERE id = ? and symbol = ?", $_SESSION["id"], strtoupper($_POST["code"]));
            ...
            $query = query("DELETE FROM holdings where id = ? and symbol = ?", $_SESSION["id"], strtoupper($_POST["code"]));
            if ($query === false)
            {
